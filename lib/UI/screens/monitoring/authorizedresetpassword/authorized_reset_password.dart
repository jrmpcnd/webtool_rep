...
class Authorizedresetpassword extends StatefulWidget {
  const Authorizedresetpassword({Key? key}) : super(key: key);

  @override
  State<Authorizedresetpassword> createState() =>
      _AuthorizedresetpasswordState();
}

class _AuthorizedresetpasswordState extends State<Authorizedresetpassword> {
  @override
