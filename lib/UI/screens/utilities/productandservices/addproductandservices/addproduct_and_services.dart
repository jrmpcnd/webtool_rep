...
class Addproductandservices extends StatefulWidget {
  const Addproductandservices({Key? key}) : super(key: key);

  @override
  State<Addproductandservices> createState() => _AddproductandservicesState();
}

class _AddproductandservicesState extends State<Addproductandservices> {
  bool value = false;
  @override
