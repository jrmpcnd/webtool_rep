...
class Webtool_User_Listing_Api {
  String? retCode;
  String? message;
  List<Webtool_User_Listing_Logs>? data;

  Webtool_User_Listing_Api({this.retCode, this.message, this.data});

  Webtool_User_Listing_Api.fromJson(Map<String, dynamic> json) {
    retCode = json['retCode'];
    message = json['message'];
    if (json['data'] != null) {
      data = <Webtool_User_Listing_Logs>[];
      json['data'].forEach((v) {
        data!.add(new Webtool_User_Listing_Logs.fromJson(v));
      });
    }
  }
...
class Webtool_User_Listing_Logs {
  String? reportId;
  String? reportParam;
  String? userName;
  String? branchDesc;
  ...
  Webtool_User_Listing_Logs.fromJson(Map<String, dynamic> json) {
    reportId = json['report_id'];
    reportParam = json['report_param'];
    userName = json['user_name'];
    branchDesc = json['branch_desc'];
...
class Transaction_log_Api {
  String? retCode;
  String? message;
  List<Transaction_Logs>? data;

  Transaction_log_Api({this.retCode, this.message, this.data});

  Transaction_log_Api.fromJson(Map<String, dynamic> json) {
    retCode = json['retCode'];
    message = json['message'];
    if (json['data'] != null) {
      data = <Transaction_Logs>[];
      json['data'].forEach((v) {
        data!.add(new Transaction_Logs.fromJson(v));
      });
    }
  }
  Map<String, dynamic> toJson() {
...
class Transaction_Logs {
  ...
  Transaction_Logs.fromJson(Map<String, dynamic> json) {
    reportId = json['report_id'];
    reportParam = json['report_param'];
    userName = json['user_name'];
    branchDesc = json['branch_desc'];
...
class Remittance_Sent_Api {
  String? retCode;
  String? message;
  List<Remittance_Sent_Log>? data;

  Remittance_Sent_Api({this.retCode, this.message, this.data});

  Remittance_Sent_Api.fromJson(Map<String, dynamic> json) {
    retCode = json['retCode'];
    message = json['message'];
    if (json['data'] != null) {
      data = <Remittance_Sent_Log>[];
      json['data'].forEach((v) {
        data!.add(new Remittance_Sent_Log.fromJson(v));
      });
    }
  }
  Map<String, dynamic> toJson() {
...
class Remittance_Sent_Log {
  ...
  Remittance_Sent_Log.fromJson(Map<String, dynamic> json) {
    reportId = json['report_id'];
    reportParam = json['report_param'];
    userName = json['user_name'];
    branchDesc = json['branch_desc'];
...
class Active_History_Api {
  String? retCode;
  String? message;
  List<Remittance_Sent_Log>? data;

  Active_History_Api({this.retCode, this.message, this.data});

  Active_History_Api.fromJson(Map<String, dynamic> json) {
    retCode = json['retCode'];
    message = json['message'];
    if (json['data'] != null) {
      data = <Remittance_Sent_Log>[];
...
class Active_History_Log {
  ...
  Active_History_Log.fromJson(Map<String, dynamic> json) {
    reportId = json['report_id'];
    reportParam = json['report_param'];
    userName = json['user_name'];
    branchDesc = json['branch_desc'];
...
class Mpin_Change_Password_Api {
  String? retCode;
  String? message;
  List<Mpin_Change_Password_Logs>? data;

  Mpin_Change_Password_Api({this.retCode, this.message, this.data});

  Mpin_Change_Password_Api.fromJson(Map<String, dynamic> json) {
    retCode = json['retCode'];
    message = json['message'];
    if (json['data'] != null) {
      data = <Mpin_Change_Password_Logs>[];
      json['data'].forEach((v) {
        data!.add(new Mpin_Change_Password_Logs.fromJson(v));
      });
    }
  }
  Map<String, dynamic> toJson() {
...
class Mpin_Change_Password_Logs {
  String? reportId;
  String? reportParam;
  String? userName;
  String? branchDesc;
  ...
  Mpin_Change_Password_Logs.fromJson(Map<String, dynamic> json) {
    reportId = json['report_id'];
    reportParam = json['report_param'];
    userName = json['user_name'];
    branchDesc = json['branch_desc'];
...
class Resend_Sms_Activation_Api {
  String? retCode;
  String? message;
  List<Resend_SMS_Logs>? data;

  Resend_Sms_Activation_Api({this.retCode, this.message, this.data});

  Resend_Sms_Activation_Api.fromJson(Map<String, dynamic> json) {
    retCode = json['retCode'];
    message = json['message'];
    if (json['data'] != null) {
      data = <Resend_SMS_Logs>[];
      json['data'].forEach((v) {
        data!.add(new Resend_SMS_Logs.fromJson(v));
      });
    }
  }
  Map<String, dynamic> toJson() {
...
class Resend_SMS_Logs {
  ...
  Resend_SMS_Logs.fromJson(Map<String, dynamic> json) {
    reportId = json['report_id'];
    reportParam = json['report_param'];
    userName = json['user_name'];
    branchDesc = json['branch_desc'];
