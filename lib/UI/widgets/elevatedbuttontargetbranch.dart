...
class elevatedbuttontargetbranch extends StatefulWidget {
  String? code;
  String? description;
  String? label = "";
  double? width;
  ...
  @override
  State<elevatedbuttontargetbranch> createState() => _elevatedbuttonpopupState();
}

class _elevatedbuttonpopupState extends State<elevatedbuttontargetbranch> {
  BranchApilist _branchApilist = BranchApilist();
  BranchDrop _branchDrop = BranchDrop();
  final List<elevatedbuttontargetbranch> branches = [];
  ...
  void fetchData() async {
    ...
    for (var i in _branchDrop.data!) {
      print(i.branchDesc);
      print(i.branchCode);
      branches.add(elevatedbuttontargetbranch(code: i.branchCode, description: i.branchDesc));
    }
    setState(() {});
  }
  ...
  List<elevatedbuttontargetbranch> getPaginatedBranches() {
