...
import 'package:webtool_rep/UI/screens/monitoring/listofagent/components/get_unit_Api.dart';
import '../utils/constant.dart';
import '../utils/text_styles.dart';
import 'package:http/http.dart' as http;

class elevatedbuttonpopupunit extends StatefulWidget {
  String? code;
  String? description;
  String? label = "";
  double? width;
  elevatedbuttonpopupunit(
      {Key? key, this.label, this.width, this.code, this.description})
      : super(key: key);

  @override
  State<elevatedbuttonpopupunit> createState() => _elevatedbuttonpopupunitState();
}

class _elevatedbuttonpopupunitState extends State<elevatedbuttonpopupunit> {
  UnitApiList _unitApiList = UnitApiList();
  get_unit_drop _unitdrop = get_unit_drop();
  final List<elevatedbuttonpopupunit> institution = [];

  void fetchData() async {
    institution.clear();
    http.Response response = await _unitApiList.getUserstatus();

    _unitdrop = get_unit_drop.fromJson(jsonDecode(response.body));
    for (var i in _unitdrop.data!) {
      print(i.unitCode);
      print(i.unitDesc);
      institution.add(elevatedbuttonpopupunit(code: i.unitDesc, description: i.unitCode));
    }
  }
  ...
  List<elevatedbuttonpopupunit> getPaginatedBranches() {
