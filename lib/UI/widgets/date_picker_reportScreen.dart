...
class DatePickerReportScreen extends StatefulWidget {
  @override
  _DatePickerReportScreenState createState() => _DatePickerReportScreenState();
}

class _DatePickerReportScreenState extends State<DatePickerReportScreen> {
  DateTime? startDate;
  DateTime? endDate;
            ...
            SizedBox(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  hintText: 'Submited Date Start',hintStyle: TextStyle(color: Colors.black,fontSize: 11),
