...
class elevatedbuttonBranchName extends StatefulWidget {
  String? code;
  String? description;
  String? label = "";
  double? width;
  ...
  @override
  State<elevatedbuttonBranchName> createState() => _elevatedbuttonpopupState();
}

class _elevatedbuttonpopupState extends State<elevatedbuttonBranchName> {
  BranchApilist _branchApilist = BranchApilist();
  BranchDrop _branchDrop = BranchDrop();
  final List<elevatedbuttonBranchName> branches = [];
  ...
  void fetchData() async {
    ...
    for (var i in _branchDrop.data!) {
      print(i.branchDesc);
      print(i.branchCode);
      branches.add(elevatedbuttonBranchName(code: i.branchCode, description: i.branchDesc));
    }
    setState(() {});
  }
  ...
  List<elevatedbuttonBranchName> getPaginatedBranches() {
